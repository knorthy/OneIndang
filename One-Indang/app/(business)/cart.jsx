...
// --- UPSELL DATA ---
const UPSELL_ITEMS = [
    { id: 'u1', name: 'Siomai (4pcs)', price: 45.00, img: 'https://i.ibb.co/VmxPqGj/siomai-transparent.png', qty: 1 },
    { id: 'u2', name: 'Coke Regular', price: 35.00, img: 'https://i.ibb.co/N6pP7Yx/chaofan-transparent.png', qty: 1 },
    { id: 'u3', name: 'Buchi (2pcs)', price: 40.00, img: 'https://i.ibb.co/VmxPqGj/siomai-transparent.png', qty: 1 },
];
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.upsellScroll}>
                {UPSELL_ITEMS.map((item) => (
                    <View key={item.id} style={styles.upsellCard}>
                        <Image source={{ uri: item.img }} style={styles.upsellImg} />
        ...
        <View style={styles.summaryContainer}>
            ...
            <View style={styles.summaryRow}>
                <View style={{flexDirection:'row', alignItems:'center'}}>
                    ...
                    <Ionicons name="information-circle-outline" size={16} color="#888" style={{marginLeft:4}} />
                </View>
        ...
        <TouchableOpacity style={styles.voucherBtn}>
            <MaterialCommunityIcons name="ticket-percent-outline" size={24} color="#555" />
        ...
        <View style={styles.cutleryRow}>
            <View style={{flexDirection:'row', alignItems:'center'}}>
                <MaterialCommunityIcons name="silverware-fork-knife" size={20} color="#555" />
                <Text style={styles.cutleryText}>Cutlery</Text>
            </View>
            <Ionicons name="toggle" size={40} color={BRAND_RED} />
        </View>
...
const styles = StyleSheet.create({
  ...
  qtyText: { fontSize: 14, fontWeight: 'bold', paddingHorizontal: 5 },
  ...
  upsellName: { fontSize: 12, fontWeight: 'bold', textAlign: 'center', marginBottom: 2 },
  upsellPrice: { fontSize: 11, color: '#666', marginBottom: 5 },
  upsellAdd: { position: 'absolute', right: 5, bottom: 5, backgroundColor: BRAND_RED, borderRadius: 15, padding: 4, elevation: 2 },
  ...
  footerTotalLabel: { fontSize: 16, fontWeight: 'bold' },
  footerTotalValue: { fontSize: 18, fontWeight: 'bold' },
  checkoutBtn: { backgroundColor: '#C2185B', paddingVertical: 15, borderRadius: 8, alignItems: 'center' },
